...
def exists_and_compiles():
    """n_odd_numbers_v2.c exists"""
    check50.exists("n_odd_numbers_v2.c")

    """n_odd_numbers_v2.c compiles"""
    check50.c.compile("n_odd_numbers_v2.c", lcs50=False)

    include_test_files()

@check50.check(exists_and_compiles)
def n_odd_numbers_test1():
    test_input_output("input1.txt", "expected_output1.txt");

@check50.check(exists_and_compiles)
def n_odd_numbers_test2():
    test_input_output("input2.txt", "expected_output2.txt");

@check50.check(exists_and_compiles)
def n_odd_numbers_test3():
