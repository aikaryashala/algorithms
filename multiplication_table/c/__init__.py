...
EXECUTABLE = "./multiplication_table"
...
def exists_and_compiles():
    """multiplication_table.c exists"""
    check50.exists("multiplication_table.c")

    """multiplication_table.c compiles"""
    check50.c.compile("multiplication_table.c", lcs50=False)
