...
EXECUTABLE = "python3 sum_of_even_up_to_n.py"
...
def exists_and_compiles():
    """sum_of_even_up_to_n.py exists"""
    check50.exists("sum_of_even_up_to_n.py")
    include_test_files()

@check50.check(exists_and_compiles)
def sum_of_even_up_to_n_10():
    test_input_output("input1.txt", "expected_output1.txt")

@check50.check(exists_and_compiles)
def sum_of_even_up_to_n_5():
    test_input_output("input2.txt", "expected_output2.txt")

@check50.check(exists_and_compiles)
def sum_of_even_up_to_n_1():
