...
EXECUTABLE = "./sum_of_n_natural_numbers"
...
def exists_and_compiles():
    """sum_of_n_natural_numbers.c exists"""
    check50.exists("sum_of_n_natural_numbers.c")

    """sum_of_n_natural_numbers.c compiles"""
    check50.c.compile("sum_of_n_natural_numbers.c", lcs50=False)

    include_test_files()

@check50.check(exists_and_compiles)
def sum_of_n_natural_numbers_test1():
    test_input_output("input1.txt", "expected_output1.txt")

@check50.check(exists_and_compiles)
def sum_of_n_natural_numbers_test2():
    test_input_output("input2.txt", "expected_output2.txt")

@check50.check(exists_and_compiles)
def sum_of_n_natural_numbers_test3():
