...
EXECUTABLE = "./even_numbers_up_to_n"
...
def exists_and_compiles():
    """even_numbers_up_to_n.c exists"""
    check50.exists("even_numbers_up_to_n.c")

    """even_numbers_up_to_n.c compiles"""
    check50.c.compile("even_numbers_up_to_n.c", lcs50=False)

    include_test_files()

@check50.check(exists_and_compiles)
def even_numbers_up_to_n_test1():
    test_input_output("input1.txt", "expected_output1.txt");

@check50.check(exists_and_compiles)
def even_numbers_up_to_n_test2():
    test_input_output("input2.txt", "expected_output2.txt");

@check50.check(exists_and_compiles)
def even_numbers_up_to_n_test3():
