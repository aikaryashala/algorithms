...
EXECUTABLE = "python3 odd_numbers_up_to_n.py"
...
def exists_and_compiles():
    """odd_numbers_up_to_n.py exists"""
    check50.exists("odd_numbers_up_to_n.py")
    include_test_files()

@check50.check(exists_and_compiles)
def odd_numbers_up_to_n_test1():
    test_input_output("input1.txt", "expected_output1.txt");

@check50.check(exists_and_compiles)
def odd_numbers_up_to_n_test2():
    test_input_output("input2.txt", "expected_output2.txt");

@check50.check(exists_and_compiles)
def odd_numbers_up_to_n_test3():
